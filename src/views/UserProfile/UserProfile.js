        ...
        <GridItem xs={12} sm={12} md={4}>
          <Card profile>
            ...
            <CardBody profile>
              ...
              <h4 className={classes.cardTitle}>Sudan Gurung</h4>
              <p className={classes.description}>
                ...
                9,000 fatalities and nearly 22,000 injured people.All of the
                hospitals in Kathmandu were in chaos and unmanaged with injured
                people flowing in rapidly. The National Trauma Center, a
                government hospital, was no exception. After hearing the
                Information, several youths went to the trauma hospital and
                offered to volunteer in order to control the situation. Our
                organization founder, Mr. Sudan Gurung, was also one of them.The
